 ...
 */
void mostrar_ayuda(char ruta_file_ayuda[]){
  ...
  FILE* file_ayudas;
  char mensaje_ayuda[200] = "";
  file_ayudas = fopen(ruta_file_ayuda,MODO_LECTURA);

  //fscanf(file_ayudas,"%[^\n]\n", mensaje_ayuda);
  fgets(mensaje_ayuda,200,file_ayudas);
  while(!feof(file_ayudas)){ 
    //printf("%s\n", mensaje_ayuda);
    //fscanf(file_ayudas,"%[^\n]\n", mensaje_ayuda);
